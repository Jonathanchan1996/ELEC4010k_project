...
template = []
names = ["No image", "Obama", "Avril", "chinese", "Levi", "Fgt"]
template.append(cv2.cvtColor(cv2.imread('/home/jonathan/catkin_ws/src/image_detect/picture/obama.jpg'), cv2.COLOR_BGR2GRAY))
template.append(cv2.cvtColor(cv2.imread('/home/jonathan/catkin_ws/src/image_detect/picture/avril_bet.jpg'), cv2.COLOR_BGR2GRAY))
template.append(cv2.cvtColor(cv2.imread('/home/jonathan/catkin_ws/src/image_detect/picture/chinese.jpg'), cv2.COLOR_BGR2GRAY))
template.append(cv2.cvtColor(cv2.imread('/home/jonathan/catkin_ws/src/image_detect/picture/levi.jpg'), cv2.COLOR_BGR2GRAY))
template.append(cv2.cvtColor(cv2.imread('/home/jonathan/catkin_ws/src/image_detect/picture/bloom.jpg'), cv2.COLOR_BGR2GRAY))
